    ...
    class SpatialCalibration
    {
        public:
            ...
            bool calibrate( const Eigen::Matrix3d& camera_matrix, const Eigen::MatrixXd& pattern_3d, const std::vector<Eigen::Isometry3d>& world2hands, const std::vector<Eigen::MatrixXd>& pattern_2ds, Eigen::Isometry3d& hand2eye, Eigen::Isometry3d& object2world, const OptimizationParams& params )
            {
                ...
                //std::cout << "BB0" << std::endl;
                object2world_vertex_2 = new g2o::VertexSE3();
                //std::cout << "BB1" << std::endl;
                object2world_vertex_2->setEstimate( object2world );
                //std::cout << "BB2" << std::endl;
                object2world_vertex_2->setId( graph->vertices().size() );
                //std::cout << "BB3" << std::endl;
                graph->addVertex( object2world_vertex_2 );
                //exit(0);
                ...
                {
                    //std::cout << "i : " << i << " / " << world2hands.size() << std::endl;
                    // object2eye vertex
        ...
        private:
            ...
            g2o::VertexSE3* object2world_vertex_2;
